...
<%
	...
	String edadCandidato			= (String)request.getAttribute("edad");
	String nacionalidad				= (String)request.getAttribute("nacionalidad");
	String estadoNacimiento			= (String)request.getAttribute("estadoNacimiento");
	String ciudadNacimiento			= (String)request.getAttribute("ciudadNacimiento");	 
	String religionAlumno			= (String)request.getAttribute("religionAlumno");
	...
	String paisDomicilio 			= (String)request.getAttribute("paisDomicilio");
	...
	try{		
		...
		celda = new PdfPCell(new Phrase(admUsuario.getNombre()
				, FontFactory.getFont(FontFactory.HELVETICA, 8, Font.BOLD, new BaseColor(r,g,b))));
		celda.setHorizontalAlignment(Element.ALIGN_CENTER);
		celda.setBorder(Rectangle.NO_BORDER);
		table3.addCell(celda);

		celda = new PdfPCell(new Phrase(admUsuario.getApellidoPaterno()==null ? "" : admUsuario.getApellidoPaterno()
				, FontFactory.getFont(FontFactory.HELVETICA, 8, Font.BOLD, new BaseColor(r,g,b))));
		celda.setHorizontalAlignment(Element.ALIGN_CENTER);
		celda.setBorder(Rectangle.NO_BORDER);
		table3.addCell(celda);
		
		celda = new PdfPCell(new Phrase(admUsuario.getApellidoMaterno()==null ? "" : admUsuario.getApellidoMaterno() 
				, FontFactory.getFont(FontFactory.HELVETICA, 8, Font.BOLD, new BaseColor(r,g,b))));
		celda.setHorizontalAlignment(Element.ALIGN_CENTER);
		celda.setBorder(Rectangle.NO_BORDER);
		table3.addCell(celda);
		...
		celda = new PdfPCell(new Phrase(ciudadNacimiento, FontFactory.getFont(FontFactory.HELVETICA, 8, Font.BOLD, new BaseColor(r,g,b))));
		celda.setHorizontalAlignment(Element.ALIGN_CENTER);
		celda.setBorder(Rectangle.NO_BORDER);
		table4.addCell(celda);
		
		celda = new PdfPCell(new Phrase(estadoNacimiento, FontFactory.getFont(FontFactory.HELVETICA, 8, Font.BOLD, new BaseColor(r,g,b))));
		celda.setHorizontalAlignment(Element.ALIGN_CENTER);
		celda.setBorder(Rectangle.NO_BORDER);
		table4.addCell(celda);
		...
		celda = new PdfPCell(new Phrase(admUsuario.getFechaNac()
				, FontFactory.getFont(FontFactory.HELVETICA, 8, Font.BOLD, new BaseColor(r,g,b))));
		celda.setHorizontalAlignment(Element.ALIGN_CENTER);
		celda.setBorder(Rectangle.NO_BORDER);
		table5.addCell(celda);
		
		celda = new PdfPCell(new Phrase(edadCandidato, FontFactory.getFont(FontFactory.HELVETICA, 8, Font.BOLD, new BaseColor(r,g,b))));
		celda.setHorizontalAlignment(Element.ALIGN_CENTER);
		celda.setBorder(Rectangle.NO_BORDER);
		table5.addCell(celda);
		...
		if(admUsuario.getEstadoCivil()!=null){
			if(admUsuario.getEstadoCivil().equals("C")){
				if(admUsuario.getGenero().equals("M"))estadoCivil="Casado";
				else estadoCivil="Casada";
			}
			if(admUsuario.getEstadoCivil().equals("S")){
				if(admUsuario.getGenero().equals("M"))estadoCivil="Soltero";
				else estadoCivil="Soltera";
			}
			if(admUsuario.getEstadoCivil().equals("V")){
				if(admUsuario.getGenero().equals("M"))estadoCivil="Viudo";
				else estadoCivil="Viuda";
			}
			if(admUsuario.getEstadoCivil().equals("D")){
				if(admUsuario.getGenero().equals("M"))estadoCivil="Divorciado";
		...
		celda = new PdfPCell(new Phrase(admUsuario.getGenero()
				, FontFactory.getFont(FontFactory.HELVETICA, 8, Font.BOLD, new BaseColor(r,g,b))));
		celda.setHorizontalAlignment(Element.ALIGN_CENTER);
		celda.setBorder(Rectangle.NO_BORDER);
		table5.addCell(celda);
		...
		int colspan = 1;
		if(!admUsuario.getReligionId().equals("1")) colspan = 2;
		celda = new PdfPCell(new Phrase(religionAlumno, FontFactory.getFont(FontFactory.HELVETICA, 8, Font.BOLD, new BaseColor(r,g,b))));
		celda.setHorizontalAlignment(Element.ALIGN_CENTER);
		...
		ciudad 		= admTutor.getCiudadId()==null?"":admTutor.getCiudadId();
		estado 		= admTutor.getEstadoId()==null?"":admTutor.getEstadoId();
		pais 		= admTutor.getPaisId()==null?"":admTutor.getPaisId();
		...
		celda = new PdfPCell(new Phrase(admUsuario.getTelefono()==null?"":admUsuario.getTelefono(), FontFactory.getFont(FontFactory.HELVETICA, 8, Font.BOLD, new BaseColor(r,g,b))));
		celda.setHorizontalAlignment(Element.ALIGN_CENTER);
		celda.setBorder(Rectangle.NO_BORDER);
		table63.addCell(celda);
		
		celda = new PdfPCell(new Phrase(admUsuario.getEmail()==null?"":admUsuario.getEmail(), FontFactory.getFont(FontFactory.HELVETICA, 8, Font.BOLD, new BaseColor(r,g,b))));
		celda.setHorizontalAlignment(Element.ALIGN_CENTER);
		celda.setBorder(Rectangle.NO_BORDER);
		table63.addCell(celda);
		...
		celda = new PdfPCell(new Phrase(calle, FontFactory.getFont(FontFactory.HELVETICA, 8, Font.BOLD, new BaseColor(r,g,b))));
		celda.setHorizontalAlignment(Element.ALIGN_CENTER);
		celda.setBorder(Rectangle.NO_BORDER);
		table6.addCell(celda);
		
		celda = new PdfPCell(new Phrase(numero, FontFactory.getFont(FontFactory.HELVETICA, 8, Font.BOLD, new BaseColor(r,g,b))));
		celda.setHorizontalAlignment(Element.ALIGN_CENTER);
		celda.setBorder(Rectangle.NO_BORDER);
		table6.addCell(celda);
		
		celda = new PdfPCell(new Phrase(colonia, FontFactory.getFont(FontFactory.HELVETICA, 8, Font.BOLD, new BaseColor(r,g,b))));
		celda.setHorizontalAlignment(Element.ALIGN_CENTER);
		celda.setBorder(Rectangle.NO_BORDER);
		table6.addCell(celda);
		...
		// Solo lee un registro de la lista
		...
		String estudioPais = "-";
		if (mapaPaises.containsKey(paisEstudio)){
			estudioPais = mapaPaises.get(paisEstudio).getNombrePais();
		}	
		...
		celda = new PdfPCell(new Phrase(" "+admSalud.getEnfermedadDato()==null?"-":admSalud.getEnfermedadDato(), FontFactory.getFont(FontFactory.HELVETICA, 8, Font.BOLD, new BaseColor(r,g,b))));
		...
		celda = new PdfPCell(new Phrase(admPadres.getPadreOcupacion(), FontFactory.getFont(FontFactory.HELVETICA, 8, Font.BOLD, new BaseColor(r,g,b))));
		celda.setHorizontalAlignment(Element.ALIGN_CENTER);
		celda.setBorder(Rectangle.NO_BORDER);
		table13.addCell(celda);
		...
		celda = new PdfPCell(new Phrase(admUsuario.getNombre()+" "+admUsuario.getApellidoPaterno()+" "+admUsuario.getApellidoMaterno()
				, FontFactory.getFont(FontFactory.HELVETICA, 8, Font.BOLD, new BaseColor(r,g,b))));
		celda.setHorizontalAlignment(Element.ALIGN_LEFT);
		celda.setBorder(Rectangle.NO_BORDER);
		table18.addCell(celda);
