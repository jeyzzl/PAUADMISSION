...
<%
	...
	try{		
        ...
        parrafo.add(new Phrase("Pegue una fotografÌa\nreciente en este\nespacio\n\n"
		...
		celda = new PdfPCell(new Phrase("Solicitud de AdmisiÛn/ Admision Form"
		...
		celda = new PdfPCell(new Phrase("InformaciÛn Personal/ Personal Information"
		...
		celda = new PdfPCell(new Phrase("PAÕS/ COUNTRY"
				, FontFactory.getFont(FontFactory.HELVETICA, 6, Font.BOLD, new BaseColor(255,255,255))));
		celda.setHorizontalAlignment(Element.ALIGN_CENTER);
		celda.setBackgroundColor(new BaseColor(0,0,0));
		celda.setBorder(Rectangle.BOX);
		...
		celda = new PdfPCell(new Phrase("TEL…âFONO/ TELEPHONE"
				, FontFactory.getFont(FontFactory.HELVETICA, 6, Font.BOLD, new BaseColor(255,255,255))));
		celda.setHorizontalAlignment(Element.ALIGN_CENTER);
		celda.setBackgroundColor(new BaseColor(0,0,0));
		celda.setBorder(Rectangle.BOX);
		...
		celda = new PdfPCell(new Phrase("InformaciÛn AcadÈmica/ Academia Information"
				, FontFactory.getFont(FontFactory.HELVETICA, 10, Font.BOLD, new BaseColor(r,g,b))));
		celda.setHorizontalAlignment(Element.ALIGN_CENTER);
		celda.setBorder(Rectangle.NO_BORDER);
		celda.setColspan(2);
		...
		celda = new PdfPCell(new Phrase("6. Antecedentes AcadÈmicos/ Academic Background"
				, FontFactory.getFont(FontFactory.HELVETICA, 8, Font.BOLD, new BaseColor(r,g,b))));
		celda.setHorizontalAlignment(Element.ALIGN_LEFT);
		celda.setBorder(Rectangle.NO_BORDER);
		celda.setColspan(4);
		...
		celda = new PdfPCell(new Phrase("TÕçTULO/ TITLE"
				, FontFactory.getFont(FontFactory.HELVETICA, 6, Font.BOLD, new BaseColor(255,255,255))));
		celda.setHorizontalAlignment(Element.ALIGN_CENTER);
		celda.setBackgroundColor(new BaseColor(0,0,0));
		celda.setBorder(Rectangle.BOX);
		...
		celda = new PdfPCell(new Phrase("INSTITUCI”ìN/ INSTITUTION"
				, FontFactory.getFont(FontFactory.HELVETICA, 6, Font.BOLD, new BaseColor(255,255,255))));
		celda.setHorizontalAlignment(Element.ALIGN_CENTER);
		celda.setBackgroundColor(new BaseColor(0,0,0));
		celda.setBorder(Rectangle.BOX);
		...
		for(int i=0; i<lista.size(); i++){
			...
			celda = new PdfPCell(new Phrase(tmp.getCompleto().equals("S")?"SÕç":"No"
					, FontFactory.getFont(FontFactory.HELVETICA, 8, Font.BOLD, new BaseColor(r,g,b))));
			celda.setHorizontalAlignment(Element.ALIGN_LEFT);
			celda.setBorder(Rectangle.BOX);
			table9.addCell(celda);
		...
		celda = new PdfPCell(new Phrase("8. InformaciÛn sobre su salud/ Health Information"
				, FontFactory.getFont(FontFactory.HELVETICA, 8, Font.BOLD, new BaseColor(r,g,b))));
		celda.setHorizontalAlignment(Element.ALIGN_LEFT);
		celda.setBorder(Rectangle.NO_BORDER);
		celda.setColspan(3);
		...
		celda = new PdfPCell(new Phrase("IMPEDIMENTO FÕçSICO/ PHYSICAL IMPEDIMENT"
				, FontFactory.getFont(FontFactory.HELVETICA, 6, Font.BOLD, new BaseColor(255,255,255))));
		celda.setHorizontalAlignment(Element.ALIGN_CENTER);
		celda.setBackgroundColor(new BaseColor(0,0,0));
		celda.setBorder(Rectangle.BOX);
		...
		celda = new PdfPCell(new Phrase("InformaciÛn sobre sus padres/ Information About Your Parents"
				, FontFactory.getFont(FontFactory.HELVETICA, 10, Font.BOLD, new BaseColor(r,g,b))));
		celda.setHorizontalAlignment(Element.ALIGN_CENTER);
		celda.setBorder(Rectangle.NO_BORDER);
		celda.setColspan(5);
		...
		celda = new PdfPCell(new Phrase("OCUPACI”ìN/ OCCUPATION"
				, FontFactory.getFont(FontFactory.HELVETICA, 6, Font.BOLD, new BaseColor(255,255,255))));
		celda.setHorizontalAlignment(Element.ALIGN_CENTER);
		celda.setBackgroundColor(new BaseColor(0,0,0));
		celda.setBorder(Rectangle.BOX);
		...
		celda = new PdfPCell(new Phrase(" RELIGI”ìN "
				, FontFactory.getFont(FontFactory.HELVETICA, 6, Font.BOLD, new BaseColor(255,255,255))));
		celda.setHorizontalAlignment(Element.ALIGN_CENTER);
		celda.setBackgroundColor(new BaseColor(0,0,0));
		celda.setBorder(Rectangle.BOX);
		...
		celda = new PdfPCell(new Phrase("11. Persona que paga la colegiatura (proveer direcciÛn solo si difiere de la anterior)/ "+
	...
	//Segunda y TERCERALinea de FORMA DE PAGO
		...
		celda = new PdfPCell(new Phrase(" N⁄öMERO / NUMBER"
				, FontFactory.getFont(FontFactory.HELVETICA, 6, Font.BOLD, new BaseColor(255,255,255))));
		celda.setHorizontalAlignment(Element.ALIGN_CENTER);
		celda.setBackgroundColor(new BaseColor(0,0,0));
		celda.setBorder(Rectangle.BOX);
		...
		celda = new PdfPCell(new Phrase("C”ìDIGO POSTAL/ ZIP CODE"
				, FontFactory.getFont(FontFactory.HELVETICA, 6, Font.BOLD, new BaseColor(255,255,255))));
		celda.setHorizontalAlignment(Element.ALIGN_CENTER);
		celda.setBackgroundColor(new BaseColor(0,0,0));
		celda.setBorder(Rectangle.BOX);
		...
		celda = new PdfPCell(new Phrase("PAÕçS/ COUNTRY"
				, FontFactory.getFont(FontFactory.HELVETICA, 6, Font.BOLD, new BaseColor(255,255,255))));
		celda.setHorizontalAlignment(Element.ALIGN_CENTER);
		celda.setBackgroundColor(new BaseColor(0,0,0));
		celda.setBorder(Rectangle.BOX);
		...
		celda = new PdfPCell(new Phrase("Hago constar que los datos sometidos en esta solicitud son verdaderos."+
				" Entiendo que es mi responsabilidad entregar toda la documentaciÛn oficial original debidamente legalizada/ autÈntificada al momento de inscribirme."+
				...
				" documentaciÛn estipulada y haber cumplido con todos mis compromisos financieros. Me comprometo a cumplir con cada uno de los reglamentos"+
				...
				" sobre mi avance acadÈmico, situaciÛn financiera y de conducta, seg˙n lo amerite el caso."
				, FontFactory.getFont(FontFactory.HELVETICA, 8, Font.NORMAL, new BaseColor(r,g,b))));
		celda.setHorizontalAlignment(Element.ALIGN_LEFT);
		celda.setBorder(Rectangle.NO_BORDER);
		celda.setColspan(1);
