...
public class AlumReferenciaDao {
	...
	public boolean insertReg( AlumReferencia alumReferencia) {
		...
		try{
			...
			System.out.println("Error - adm.alumno.spring.AlumReferenciaDao|insertReg|:"+ex);			
		}
		return ok;
	}	
	...
	public boolean updateReg( AlumReferencia alumReferencia) {
		...
		try{
			...
			System.out.println("Error - adm.alumno.spring.AlumReferenciaDao|updateReg|:"+ex);		
		}
		return ok;
	}	
	...
	public boolean deleteReg( String codigoPersonal) {
		...
		try{
			...
			System.out.println("Error - adm.alumno.spring.AlumReferenciaDao|deleteReg|:"+ex);			
		}
		return ok;
	}
	...
	public AlumReferencia mapeaRegId(  String codigoPersonal ) {
		AlumReferencia objeto = new AlumReferencia();
 		...
 		try{
	 		...
	 		Object[] parametros = new Object[] {codigoPersonal};
			objeto = salomonJdbc.queryForObject(comando, new AlumReferenciaMapper(), parametros);
 		}catch(Exception ex){
 			System.out.println("Error - adm.alumno.spring.AlumReferenciaDao|mapeaRegId|:"+ex);
 		}
 		return objeto;
 	}
	...
	public boolean existeReg( String codigoPersonal) {
		...
		try{
			...
			System.out.println("Error - adm.alumno.spring.AlumReferenciaDao|existeReg|:"+ex);
		}
		return ok;
	}
...
//----------------COMPLETAR CON CEROS---------------------
	...
	public List<AlumReferencia> getListAll( String orden) {
		...
		try{
			...
			lista = salomonJdbc.query(comando, new AlumReferenciaMapper());
			
		}catch(Exception ex){
			System.out.println("Error - adm.alumno.spring.AlumReferenciaDao|getListAll|:"+ex);
		}
		return lista;
	}
}