// Clase para la tabla del Cat�logo de Documentos de Admision
...
public class DocumentoUtil{
	...
	public ArrayList<AdmDocumento> getLista(Connection conn, String documentos, String orden ) throws SQLException{
