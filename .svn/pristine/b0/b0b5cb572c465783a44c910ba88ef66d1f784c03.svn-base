		...
		jQuery(this).each(function(i) {
			if (jQuery(this).is(":file")) {
				...
				jQuery("label#cabinet"+i)
					...
					.after('<div class="uploadButton"><div><table width=100% height="100%" align=center><tr><td align=center><font color=black>Seleccionar</font</td></tr></table></div></div><label class="selectedFile"></label>')
