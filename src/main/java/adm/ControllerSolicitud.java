...
public class ControllerSolicitud {
	...
	public String solicitudModalidad(HttpServletRequest request, Model modelo){
		...
		List<MapaPlan> lisPlanes = mapaPlanDao.listPlanesPorPeriodoAndModoAndNivel(periodoId, modo, nivelEstudio, "ORDER BY CARRERA_ID");	
	...
	public String solicitudMandarCorreos(HttpServletRequest request){
		...
		// SEND EMAIL DEPENDING ON INSTITUTION
		if(parametros.getInstitucion().equals("Sonoma") || parametros.getInstitucion().equals("Fulton")){
	...
	public String solicitudAcomodo(HttpServletRequest request, Model modelo){
		...
		String tipoAcomodo 			= admSolicitud.getEstadoCivil();
