	...
	public void doFilter(final ServletRequest request, final ServletResponse response, final FilterChain chain) throws IOException, ServletException {
        ...
        if (sesion != null){
        	...
        	if (!usuarioId.equals("0") 
				|| uriOriginal.contains("inicio") 
				|| uriOriginal.contains("inicial") 
				|| uriOriginal.contains("login") 
				|| uriOriginal.contains("valida") 
				|| uriOriginal.contains("salir") 
				|| uriOriginal.contains("registro") 
				|| uriOriginal.contains("encuesta") 
				|| uriOriginal.contains("intentaRecuperar") 
				|| uriOriginal.contains("recuperarContrasena")) {
