...
%>    
            <tr>
                ...
                <td>                        
                    <%=documento.getDocumentoNombre()%>     <%=requisito.getRequerido().equals("S")?"<font class='text-danger'><b>*</b></font>":""%>      
                </td>
                <td>
...
%>
            <tr>
                ...
                <td>                         
                    <%=endorsmentLetter.getDocumentoNombre()%>   <font class='text-danger'><b>*</b></font>         
                </td>
                <td>
...
<%              }%>
            ...
            <tr>
                ...
                <td>                         
                    <%=employeeReference.getDocumentoNombre()%>   <font class='text-danger'><b>*</b></font>         
                </td>
                <td>
