...
<%	
	String usuarioId 			= (String)session.getAttribute("UsuarioId")==null?"0":(String)session.getAttribute("UsuarioId");
...
<% 	if(existe){ %>
	<h4><spring:message code="restablecerContrasena.Usuario"/>: <%=admUsuario.getNombre()+" "+admUsuario.getApellidoPaterno()+" "+admUsuario.getApellidoMaterno()%></h4>
...
<% 	} %>
	...
	<input class= "form-control" type="password" id="Confirmar" name="Confirmar" required="required" maxlength="30" onkeyup="verificar();"/>
