...
<%
    ...
    //Logo Um y texto debajo
    	...
    	ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, saludo, 25, 610, 0); 
      	Phrase saludo2 = new Phrase("(PODIUM), de la carrera " + nombreCarrera + "." , fontNormal11); 
		...
		pa 		= new Paragraph();
		pa.add(new Phrase(formato.format(resLog),fontNormal11));
		celda = new PdfPCell(pa);
		celda.setHorizontalAlignment(Element.ALIGN_CENTER);
		celda.setBorder(Rectangle.BOX);
		table.addCell(celda);
		...
		pa 		= new Paragraph();
		pa.add(new Phrase(formato.format(resMat),fontNormal11));
		celda = new PdfPCell(pa);
		celda.setHorizontalAlignment(Element.ALIGN_CENTER);
		celda.setBorder(Rectangle.BOX);
		table.addCell(celda);
		...
		pa 		= new Paragraph();
		pa.add(new Phrase(formato.format(resEsp),fontNormal11));
		celda = new PdfPCell(pa);
		celda.setHorizontalAlignment(Element.ALIGN_CENTER);
		celda.setBorder(Rectangle.BOX);
		table.addCell(celda);
		...
		pa 		= new Paragraph();
		pa.add(new Phrase(formato.format(resIng),fontNormal11));
		celda = new PdfPCell(pa);
		celda.setHorizontalAlignment(Element.ALIGN_CENTER);
		celda.setBorder(Rectangle.BOX);
		table.addCell(celda);
		...
		if(carreraId.equals("10301")||carreraId.equals("10314")||carreraId.equals("10313")||carreraId.equals("10303")){
			...
			pa 		= new Paragraph();
			pa.add(new Phrase(formato.format(resBio),fontNormal11));
			celda = new PdfPCell(pa);
			celda.setHorizontalAlignment(Element.ALIGN_CENTER);
			celda.setBorder(Rectangle.BOX);
			table.addCell(celda);
			...
			pa 		= new Paragraph();
			pa.add(new Phrase(formato.format(resFis),fontNormal11));
			celda = new PdfPCell(pa);
			celda.setHorizontalAlignment(Element.ALIGN_CENTER);
			celda.setBorder(Rectangle.BOX);
			table.addCell(celda);
			...
			pa 		= new Paragraph();
			pa.add(new Phrase(formato.format(resQui),fontNormal11));
			celda = new PdfPCell(pa);
			celda.setHorizontalAlignment(Element.ALIGN_CENTER);
			celda.setBorder(Rectangle.BOX);
			table.addCell(celda);
