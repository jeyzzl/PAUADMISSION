...
<script type="text/javascript">
	...
	function revisa(){
		...
		var nacPais 	= document.getElementById("nacPais").value;
		...
		if(titulo != "-" && titulo != ""){
				...
				if(nacPais != "0"){
					if(fin != "-" && fin != ""){
						if(estudios != "0"){
							...
							alert("Highest academic level attained is required");
							$("fin").focus();
						}
					}else{
						alert("Year Completed is required");
						$("fin").focus();
					}
				}else{
			...
			alert("Name of Degree is required");
			$("titulo").focus();
		}
		return false;
	}
		...
		<div class="row">
			...
			<div class="col-lg-12" style="background-color:white; min-height:calc(100vh - 37px);">
				...
				<div class="alert alert-info" role="alert">
					<a class="btn btn-primary text-decoration-none" href="<%=request.getContextPath()%>/solicitud/otroEstudio">Return</a>&nbsp;&nbsp; <spring:message code="solicitud.estudios.MensajeAntecedentes"/>
				</div>
				<div class="well">
					<div class="row">
...
<%	if(admSolicitud.getNivelEstudio().equals("U") && admSolicitud.getTipo().equals("S")){	%>
									...
									<%-- <option value="4" <%=estudio.getEstudios().equals("4")?"selected":""%>><spring:message code="solicitud.estudios.Certificado"/></option> --%>
									<%-- <option value="5" <%=estudio.getEstudios().equals("4")?"selected":""%>><spring:message code="solicitud.estudios.Tecnica"/></option> --%>
									<%-- <option value="6" <%=estudio.getEstudios().equals("5")?"selected":""%>><spring:message code="solicitud.estudios.Licenciatura"/></option> --%>
									<%-- <option value="7" <%=estudio.getEstudios().equals("6")?"selected":""%>><spring:message code="solicitud.estudios.Especializacion"/></option> --%>
									<%-- <option value="8" <%=estudio.getEstudios().equals("7")?"selected":""%>><spring:message code="solicitud.estudios.Maestria"/></option> --%>
									<%-- <option value="9" <%=estudio.getEstudios().equals("8")?"selected":""%>><spring:message code="solicitud.estudios.Doctorado"/></option> --%>
<%	}		%>
<%	if(admSolicitud.getNivelEstudio().equals("U") && (admSolicitud.getTipo().equals("N") || admSolicitud.getTipo().equals("R"))){	%>
									<option value="0" <%=estudio.getEstudios().equals("0")?"selected":""%>> <spring:message code="solicitud.estudios.Elige"/></option>
									<%-- <option value="1" <%=estudio.getEstudios().equals("1")?"selected":""%>><spring:message code="solicitud.estudios.Primaria"/></option> --%>
									<option value="2" <%=estudio.getEstudios().equals("2")?"selected":""%>><spring:message code="solicitud.estudios.Secundaria"/></option>		
									<%-- <option value="3" <%=estudio.getEstudios().equals("3")?"selected":""%>><spring:message code="solicitud.estudios.Bachillerato"/></option> --%>
									<option value="4" <%=estudio.getEstudios().equals("4")?"selected":""%>><spring:message code="solicitud.estudios.Certificado"/></option>
									<option value="5" <%=estudio.getEstudios().equals("5")?"selected":""%>><spring:message code="solicitud.estudios.Tecnica"/></option>
									<%-- <option value="6" <%=estudio.getEstudios().equals("5")?"selected":""%>><spring:message code="solicitud.estudios.Licenciatura"/></option> --%>
									<%-- <option value="7" <%=estudio.getEstudios().equals("6")?"selected":""%>><spring:message code="solicitud.estudios.Especializacion"/></option> --%>
									<%-- <option value="8" <%=estudio.getEstudios().equals("7")?"selected":""%>><spring:message code="solicitud.estudios.Maestria"/></option> --%>
									<%-- <option value="9" <%=estudio.getEstudios().equals("8")?"selected":""%>><spring:message code="solicitud.estudios.Doctorado"/></option> --%>
									<option value="10" <%=estudio.getEstudios().equals("10")?"selected":""%>><spring:message code="solicitud.estudios.Otro"/></option>
<%	}		%>
<%	if(admSolicitud.getNivelEstudio().equals("P")){	%>
									<option value="0" <%=estudio.getEstudios().equals("0")?"selected":""%>> <spring:message code="solicitud.estudios.Elige"/></option>
									<%-- <option value="1" <%=estudio.getEstudios().equals("1")?"selected":""%>><spring:message code="solicitud.estudios.Primaria"/></option> --%>
									<%-- <option value="2" <%=estudio.getEstudios().equals("2")?"selected":""%>><spring:message code="solicitud.estudios.Secundaria"/></option>		 --%>
									<%-- <option value="3" <%=estudio.getEstudios().equals("3")?"selected":""%>><spring:message code="solicitud.estudios.Bachillerato"/></option> --%>
									<%-- <option value="4" <%=estudio.getEstudios().equals("4")?"selected":""%>><spring:message code="solicitud.estudios.Certificado"/></option> --%>
									<%-- <option value="5" <%=estudio.getEstudios().equals("4")?"selected":""%>><spring:message code="solicitud.estudios.Tecnica"/></option> --%>
									<option value="6" <%=estudio.getEstudios().equals("6")?"selected":""%>><spring:message code="solicitud.estudios.Licenciatura"/></option>
									<option value="7" <%=estudio.getEstudios().equals("7")?"selected":""%>><spring:message code="solicitud.estudios.Especializacion"/></option>
									<option value="8" <%=estudio.getEstudios().equals("8")?"selected":""%>><spring:message code="solicitud.estudios.Maestria"/></option>
									<option value="9" <%=estudio.getEstudios().equals("9")?"selected":""%>><spring:message code="solicitud.estudios.Doctorado"/></option>
									<option value="10" <%=estudio.getEstudios().equals("10")?"selected":""%>><spring:message code="solicitud.estudios.Otro"/></option>
<%	}		%>		
								</select>&nbsp;&nbsp;<br>
								...
								<label id="labelInstitucion">Institution</label>
...
<% if (grabo){%>
	<div class="alert alert-success"><spring:message code="solicitud.estudios.Grabo"/></div>
	<meta http-equiv="refresh" content="1;url=otroEstudio?Mensaje=1" />
<% } %>