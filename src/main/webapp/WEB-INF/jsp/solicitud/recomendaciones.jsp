					...
					<div class="p-2 w-100 bd-highlight">
				  	...
				  	<div class="p-2 flex-shrink-1 bd-highlight">
				  		<div class="d-flex align-items-center">
				    		...
				    		&nbsp;<b class="fs-5">8/12</b>&nbsp;
<%						if(existe){%>
							<a href="<%=request.getContextPath()%>/solicitud/banco"><i class="fas fa-caret-right fa-3x"></i></a>
<% 						}else{
							out.print("&nbsp;");
						}%>
						</div>
...
<%						for(int i=1; i<=2; i++){ 
							...
							String direccion = request.getParameter("Direccion"+i)==null?recomienda.getDireccion():request.getParameter("Direccion"+i);
%>
					  		<div class="col">
...
<% if (grabo){ %>
	...
	<meta http-equiv="refresh" content="1;url=banco" />
<% }%>