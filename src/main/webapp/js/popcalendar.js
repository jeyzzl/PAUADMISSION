...
//	email  : pinotoy@yahoo.com
	...
	var imgDir = '../imagenes/calendar/';		// directory for images ... e.g. var imgDir="/img/"
	var dayName = '';
	...
	*/
	...
	function focusFecha(obj){
		showCalendar(obj, obj, 'dd/mm/yyyy',null,1,-1,-1);
		Event.observe(obj, "keypress", revisaTeclas);
	}
	
	function revisaTeclas(event){
		if(event.keyCode == 9){
			hideCalendar();
		}
	}
